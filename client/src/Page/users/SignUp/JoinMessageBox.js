...
const TagSvg = (
    <svg width="26" height="26">
        <path
            d="M14.8 3a2 2 0 00-1.4.6l-10 10a2 2 0 000 2.8l8.2 8.2c.8.8 2 .8 2.8 0l10-10c.4-.4.6-.9.6-1.4V5a2 2 0 00-2-2h-8.2zm5.2 7a2 2 0 110-4 2 2 0 010 4z"></path>
        <path opacity=".5"
...
const JoinMessageBox = () => {
    return (
        <MessageContainer>
            ...
            <SingleMessageContainer>
                <div>{UpDownVoteSvg}</div>
                <div>Unlock new privileges like voting and commenting
                </div>
            </SingleMessageContainer>
            <SingleMessageContainer>
                <div>{TagSvg}</div>
                <div>Save your favorite tags, filters, and jobs
                </div>
            </SingleMessageContainer>
            <SingleMessageContainer>
                <div>{TrophySvg}</div>
                <div>Earn reputation and badges
                </div>
            </SingleMessageContainer>
        </MessageContainer>
    )
